  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground font-semibold shadow-glow hover:shadow-glow-strong hover:scale-[1.02] active:scale-[0.98] animate-pulse-glow",
        heroOutline: "border border-primary/50 bg-primary/10 text-foreground backdrop-blur-sm hover:bg-primary/20 hover:border-primary",
        cta: "bg-primary text-primary-foreground font-semibold shadow-glow hover:shadow-glow-strong hover:scale-[1.02] active:scale-[0.98]",
        glass: "glass text-foreground hover:bg-secondary/50 glow-border",
      },
      size: {
